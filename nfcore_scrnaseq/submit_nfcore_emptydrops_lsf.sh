#!/bin/bash
#BSUB -J nfcore_scrnaseq_emptydrops
#BSUB -n 8
#BSUB -M 96000
#BSUB -W 8:00
#BSUB -o %J.out
...
# EmptyDrops variant (filtering enabled, no CellBender)

set -e

echo "========================================"
echo "nf-core/scrnaseq with EmptyDrops"
echo "========================================"
...
echo "Launching nf-core/scrnaseq pipeline with EmptyDrops..."
echo ""

nextflow run nf-core/scrnaseq \
    -r 3.0.0 \
    -profile singularity \
    -c nextflow_singularity_emptydrops.config \
    --input samplesheet.csv \
    --outdir results_nfcore_emptydrops \
    --aligner alevin \
    --protocol 10XV3 \
    --simpleaf_rlen 91 \
...
if [ $PIPELINE_STATUS -eq 0 ]; then
    ...
    echo "Results in: $(pwd)/results_nfcore_emptydrops"
else
